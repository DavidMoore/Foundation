...
namespace Foundation.Windows
{
    ...
    public class LoadLibraryException : BaseException
    {
        ...
        public LoadLibraryException(string file, int lastWin32Error) : base("Error when loading module \"{0}\". Error code: {1}", file, lastWin32Error) {}
        ...
        public LoadLibraryException(string message, params object[] args) : base(message, args) {}
        ...
        /// <param name="message">The formattable error message to pass to <see cref="string.Format(System.IFormatProvider,string,object[])"/></param>
        /// <param name="args">Arguments to pass to <see cref="string.Format(System.IFormatProvider,string,object[])"/></param>
        public LoadLibraryException(Exception innerException, string message, params object[] args) : base(innerException, message, args) {}
