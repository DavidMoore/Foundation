...
namespace Foundation.Data.Hierarchy
{
    public class TreeEntityChildren<T> : Collection<T> where T : class, ITreeEntity<T>, IEntity
    {
        ...
        protected override void InsertItem(int index, T item)
        {
            ...
            if (Parent.TreeInfo.Parent != null && Parent.TreeInfo.Parent.Equals(item)) throw new InvalidOperationException("An entity can't be both child and parent to the same item");
