...
namespace Microsoft.VisualStudio.Project
{
        ...
        IVsProjectSpecialFiles
    {
        ...
        protected virtual MSBuildResult InvokeMsBuild(string target)
        {
            ...
            bool requiresUIThread =Microsoft.VisualStudio.Project.UIThread.Instance.IsUIThread; // we don't run tasks that require calling the STA thread, so unless we're ON it, we don't need it.
