...
namespace Foundation.Services.Unity
{
    ...
    public static class UnityContainerExtensions
    {
        ...
        /// <see cref="IUnityContainer"/> extension to the <see cref="UnityIsTypeRegisteredExtension"/>.
        /// </remarks>        
        public static bool IsTypeRegistered(this IUnityContainer container, Type type)
        {
            return UnityIsTypeRegisteredExtension.IsTypeRegistered(container, type);
        }
