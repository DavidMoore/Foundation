...
namespace Microsoft.VisualStudio.Project {
    class BuildPropertyGroupCollectionShim : IEnumerable<BuildPropertyGroupShim> {
        private BuildPropertyGroupCollection buildPropertyGroupCollection;

        public BuildPropertyGroupCollectionShim(BuildPropertyGroupCollection buildPropertyGroupCollection) {
