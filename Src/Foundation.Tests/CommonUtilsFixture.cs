...
namespace Foundation.Tests
{
    ...
    public class CommonUtilsFixture
    {
        ...
        public void HtmlEncode()
        {
            ...
            Assert.AreEqual(expected, CommonUtils.HtmlEncode(rawText));
        }
        ...
        public void HtmlEncode_with_linebreaks_to_html()
        {
            ...
            Assert.AreEqual(expected, CommonUtils.HtmlEncode(rawText, true));
        }
        ...
        public void LineBreaksToHtml()
        {
            ...
            Assert.AreEqual(expected, CommonUtils.LineBreaksToHtml(stringWithLineBreaks));
        }

        [Test]
        public void LineBreaksToHtml_handles_null_value_by_returning_empty_string()
        {
            Assert.AreEqual(string.Empty, CommonUtils.LineBreaksToHtml(null));
        }
    }
}